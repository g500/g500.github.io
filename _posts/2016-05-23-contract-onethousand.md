...
- [github](https://github.com/OneEther/OneThousand)
...
contract TheLuckyOne {
    ...
    // 得到运行时间，如果没有截止时间就返回1337 == 22 minutes
    ...
    function recoverLostFunds() { // 恢复失去的资金
        //No deadline
        if (deadlineStart == 0) {
            return;
        }
    ...
    function () {
        ...
        uint ticketsBought; // the tickets bounght
        ...
        if (msg.value >= 25625 finney) {
            ...
            //Refund difference: refund difference
